...
public class BWT {	
	...
	public static void main(String[] args) {
		...
		//this is to offset empty entry when pulling next input	
		in.nextLine();
	//*********************START OF ENCRYPTION CODE**************************************	
		if (startTest == 1) {
			...
			//sorts the array of strings and print the sorted array
...
//Move first letter of previous string to end, then that is new string. Do this i times.		
	...
	//takes last character of each sorted string which provides the encrypted string	
